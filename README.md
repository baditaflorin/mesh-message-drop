...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh--message--drop-9668ca)](https://baditaflorin.github.io/mesh-message-drop/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-message-drop/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> A lightweight peer-to-peer message stream for a shared room.

**Live → https://baditaflorin.github.io/mesh-message-drop/**

**Source → https://github.com/baditaflorin/mesh-message-drop**
...
git clone https://github.com/baditaflorin/mesh-message-drop
cd mesh-message-drop
npm install
npm run dev
```
...
- `mesh-message-drop:signalingUrl`
- `mesh-message-drop:turnTokenUrl`
- `mesh-message-drop:iceServers`
- `mesh-message-drop:room`
